# Salita — Iteration 9: Overview click + drill (design)

**Date:** 2026-06-04  
**Status:** Approved  
**Parent spec:** `docs/salita-design-spec.md` (§4.2, §5.2)  
**Roadmap:** `docs/superpowers/specs/2026-06-02-salita-v1-roadmap-design.md` (iteration 9)  
...
| `docs/superpowers/specs/2026-06-04-salita-iteration-9-overview-click-drill-design.md` | This doc |
