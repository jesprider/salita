# Salita — Iteration 6: Store force mutations (design)

**Date:** 2026-06-03  
**Status:** Approved  
**Parent spec:** `docs/salita-design-spec.md` (full v1 — peak rule amended below)  
**Roadmap:** `docs/superpowers/specs/2026-06-02-salita-v1-roadmap-design.md` (iteration 6)  
