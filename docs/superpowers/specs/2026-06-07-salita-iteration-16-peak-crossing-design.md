# Salita — Iteration 16: Peak crossing (design)

**Date:** 2026-06-07  
**Status:** Approved  
**Parent spec:** `docs/salita-design-spec.md` (§2 peak transition, checklist item 13)  
**Roadmap:** `docs/superpowers/specs/2026-06-02-salita-v1-roadmap-design.md` (iteration 16)  
...
| `docs/superpowers/specs/2026-06-02-salita-v1-roadmap-design.md` | Mark iteration 16 **done** + link this doc when implementation ships |
