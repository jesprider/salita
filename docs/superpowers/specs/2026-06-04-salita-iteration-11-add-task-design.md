# Salita — Iteration 11: + Task (design)

**Date:** 2026-06-04  
**Status:** Approved  
**Parent spec:** `docs/salita-design-spec.md` (§4.3, §5.5)  
**Roadmap:** `docs/superpowers/specs/2026-06-02-salita-v1-roadmap-design.md` (iteration 11)  
...
| `docs/superpowers/specs/2026-06-04-salita-iteration-11-add-task-design.md` | This doc |
